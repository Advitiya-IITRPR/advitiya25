        ...
        <div className="flex flex-col items-center justify-center h-full w-full gap-1 md:gap-4 font-serif">
          ...
          <div className="block md:hidden overflow-hidden z-50">
            <section className="text-white h-32 flex-col justify-around items-center mt-6">
              <section className="flex justify-center items-center h-8"><User strokeWidth={1.75} color="white" className="text-sm" /> <pre className="min-[300px]:-ml-3 min-[390px]:ml-0">  Krish Soliya  </pre></section>
              <section className="flex justify-center items-center h-8"><Mail color="white" strokeWidth={1.75} /> <pre>  ‪2022eeb1183@iitrpr.ac.in‬  </pre></section>
              <section className="flex justify-center items-center h-8"><Phone color="white" strokeWidth={1.75} /> <pre>  ‪+91 95121 19212‬  </pre></section>
            </section>

            <section className="text-white h-32 flex-col justify-center items-center -mt-4">
              <section className="flex justify-center items-center h-8"><User strokeWidth={1.75} color="white" className="text-sm" /> <pre className="min-[300px]:-ml-3 min-[390px]:ml-0">  Mihir Kasare  </pre></section>
              <section className="flex justify-center items-center h-8"><Mail color="white" strokeWidth={1.75} /> <pre>  ‪2022chb1052@iitrpr.ac.in‬  </pre></section>
              <section className="flex justify-center items-center h-8"><Phone color="white" strokeWidth={1.75} /> <pre>  ‪+91 91367 24826‬  </pre></section>
            </section>
