    ...
    <>
      <div className="relative md:block hidden">
        <div
          ...
          className="h-[85vh] relative w-full bg-[#10171D]"
        >
          <div
          ...
          >
            <img
              ...
              className="h-full pointer-events-none absolute bg-no-repeat right-0"
            />
            <img
              src="/signin/bg1l.png"
              alt="background image"
              className="h-full pointer-events-none absolute bg-no-repeat left-0"
            />
        ...
        <div
          style={{
            transform:
              scrollY > 700 ? `translateY(${(scrollY - 700) * 0.4}px)` : "",
          }}
          className="h-[100vh] relative w-full bg-[#10171D]"
        >
          <div
            className="h-full w-full absolute shadow-2xl shadow-[#10171D] bg-cover bg-top bg-no-repeat"
        ...
        <div
          style={{
            transform:
              scrollY > 900 ? `translateY(${(scrollY - 900) * 0.2}px)` : "",
          }}
          className="h-[100vh] relative w-full bg-[#10171D]"
        >
          <div
          ...
          <img
            src="/signin/bg3b.png"
            alt="background image"
            className="w-full z-10 pointer-events-none absolute bg-no-repeat bottom-[0]"
          />
          <img
            src="/signin/bg2b.png"
            alt="background image"
            className="w-full z-10 pointer-events-none absolute bg-no-repeat bottom-[calc(100vh-120px)]"
          />
        </div>
      </div>
            ...
            <div className="flex-col h-full w-full">
              ...
              <div className="h-1/2 w-full flex items-center justify-center relative">
                <img
                  src="/signin/bgdots.png"
                  alt="background image"
                  className="z-10 pointer-events-none absolute bg-no-repeat bottom-0"
                />
                <DecorativeFrame />
              </div>
              <img
                src="/signin/bg2b.png"
                alt="background image"
                className={`w-full z-10 pointer-events-none absolute bg-no-repeat -bottom-4 sm:-bottom-8`}
              />
            </div>
          </div>
        </div>
